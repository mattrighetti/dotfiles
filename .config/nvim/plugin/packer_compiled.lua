...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["colorbuddy.vim"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/colorbuddy.vim",
  ...
  ["gruvbuddy.nvim"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/gruvbuddy.nvim",
    url = "https://github.com/tjdevries/gruvbuddy.nvim"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/undotree",
    url = "https://github.com/mbbill/undotree"
  },
  ["vim-better-whitespace"] = {
    loaded = true,
    path = "/Users/matt/.local/share/nvim/site/pack/packer/start/vim-better-whitespace",
